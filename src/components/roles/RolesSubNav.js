...
const RolesSubNav = ({ showBtn, setShowBtn }) => {
        ...
        >
          ...
          <div className='position-relative'>
            <select className='filter-field2 font-sm' style={{ width: "auto" }}>
              ...
              <option value=''>Gold Roles</option>
              <option value=''>Diamond Roles</option>
              <option value=''>Boosted Accounts</option>
              <option value=''>Verified Roles</option>
            </select>
