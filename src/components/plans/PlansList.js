...
const PlansList = ({ showBtn, setShowBtn, plansPage, setPlansPage, item }) => {
  return (
    <>
      <tr style={{ backgroundColor: "rgba(255, 255, 255, 0.65)" }}>
        ...
        <td colspan='2' onClick={() => setPlansPage("single")}>
          <div>
            <span className='f-weight-700'>Daily Boost</span>
          </div>
        </td>
        <td>
          <div>
            <span className='font-sm f-weight-600'>Profile Boost</span>
          </div>
        </td>
        <td>
          <div>
            <span className='f-weight-600'>₦570</span>
          </div>
        </td>
        <td>
          <div className='d-flex align-items-center'>
            <span className='f-weight-700'>1 day</span>
          </div>
        </td>
        <td>
      ...
      <tr style={{ backgroundColor: "rgba(255, 255, 255, 0.65)" }}>
        ...
        <td colspan='2'>
          <div>
            <span className='f-weight-700'>Solitary Membership</span>
          </div>
        </td>
        <td>
          <div>
            <span className='font-sm f-weight-600'>Seek Submission</span>
          </div>
        </td>
        <td>
          <div>
            <span className='f-weight-600'>₦2,500</span>
          </div>
        </td>
        <td>
          <div className='d-flex align-items-center'>
            <span className='f-weight-700'>One time</span>
          </div>
        </td>
        <td>
      ...
      <tr style={{ backgroundColor: "rgba(255, 255, 255, 0.65)" }}>
        ...
        <td colspan='2'>
          <div>
            <span className='f-weight-700'>Premium Membership</span>
          </div>
        </td>
        <td>
          <div>
            <span className='font-sm f-weight-600'>Subscription</span>
          </div>
        </td>
        <td>
          <div>
            <span className='f-weight-600'>₦29,000</span>
          </div>
        </td>
        <td>
          <div className='d-flex align-items-center'>
            <span className='f-weight-700'>30 days</span>
          </div>
        </td>
        <td>
          <div className='successful-status'>
      ...
      <tr style={{ backgroundColor: "rgba(255, 255, 255, 0.65)" }}>
        ...
        <td colspan='2'>
          <div>
            <span className='f-weight-700'>Gold Membership</span>
          </div>
        </td>
        <td>
          <div>
      ...
      <tr style={{ backgroundColor: "rgba(255, 255, 255, 0.65)" }}>
        ...
        <td colspan='2'>
          <div>
            <span className='f-weight-700'>Triple Boosting</span>
          </div>
        </td>
        <td>
          <div>
        ...
        <td>
          <div>
            <span className='f-weight-600'>₦1200</span>
          </div>
        </td>
        <td>
          <div className='d-flex align-items-center'>
            <span className='f-weight-700'>3 days</span>
          </div>
        </td>
        <td>
          <div className='failed-status'>
