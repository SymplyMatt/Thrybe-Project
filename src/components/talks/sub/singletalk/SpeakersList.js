  ...
  return (
    <>
        <div className="col-xl-2 col-md-4 mb-3">
            <div className="position-relative talk-images">
                <img
                    className="img-fluid"
                    src="./assets/images/singlepagepic.png"
                    alt=""
                />
                <div className="position-absolute w-100 inner-image2">
                    <div
                        className="d-flex justify-content-between align-items-center"
                    >
                        <h6
                            className="text-white pl-2 font-sm2 f-weight-700 mb-0"
                        >
                            Farouk, 23
                        </h6>
                        <button
                    ...
                    <span
                        className="text-white pl-2 font-sm f-weight-600 mb-5"
                        >Blogger</span
                    >
                </div>
                <div
...
style={{ top: '15px', right: '15px' }}
                >
                    <img
                        src="./assets/images/mutemic-icon.svg"
                        alt="mutemic-icon"
                    />
                </div>
            </div>
