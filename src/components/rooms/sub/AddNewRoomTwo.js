...
const AddNewRoomTwo = ({ page, setPage, roomsPage, setRoomsPage }) => {
  ...
  return (
    <div className='main-content'>
      <div className='container-fluid'>
        ...
        <div className='row'>
          <div
            className='custom-card col-xl-5 col-md-8 ml-3'
                ...
                <table className='table table-borderless users-table'>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <img
                            src='./assets/images/benin-flag-icon.svg'
                            alt=''
                          />
                        </div>
                      </td>
                    ...
                    >
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          <p className='f-weight-700'>
                            jenniferamoku@gmail.com
                          </p>
                        </div>
                      </td>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <img
                            src='./assets/images/ivory-coast-flag-icon.svg'
                            alt=''
                          />
                        </div>
                      </td>
