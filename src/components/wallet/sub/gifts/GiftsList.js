  ...
  return (
    <>
      <tr style={{ backgroundColor: "white" }}>
        ...
        <td onClick={() => setWalletPage("gift-single")}>
          <div className='d-flex align-items-center'>
        ...
        <td>
          <p className='mb-0 f-weight-600'>
            <span className='mr-2'>03/21/2022</span>13:45PM
          </p>
        </td>
        <td>
      ...
      <tr style={{ backgroundColor: "white" }}>
        ...
        <td>
          <div className='d-flex align-items-center'>
            ...
            <div className='ml-2'>
              <h5 className='font-sm mb-0 f-weight-600'>My Black Visa</h5>
              <p className='font-xs mb-0'>0924 ******* 5675</p>
            </div>
          </div>
        </td>
      ...
      <tr style={{ backgroundColor: "white" }}>
        ...
        <td>
          <div className='d-flex align-items-center'>
            ...
            <div className='ml-2'>
              <h5 className='font-sm mb-0 f-weight-600'>My Blue Visa</h5>
              <p className='font-xs mb-0'>0924 ******* 5675</p>
            </div>
          </div>
        </td>
      ...
      <tr style={{ backgroundColor: "white" }}>
        ...
        <td>
          <div className='d-flex align-items-center'>
            ...
            <div className='ml-2'>
              <h5 className='font-sm mb-0 f-weight-600'>My Red Visa</h5>
              <p className='font-xs mb-0'>0924 ******* 5675</p>
            </div>
          </div>
        </td>
