...
const TalksSubNav = ({ showBtn, setShowBtn }) => {
  ...
  return (
            <div className="row justify-content-between align-items-center">
                ...
                <div className="col-lg-5 mt-3">
                    <div
                        className={`align-items-center justify-content-end ${!showBtn ? 'not-show' : ''}`}
                        id="users-filter"
                    >
                    ...
                    <div className={`align-items-center ${showBtn ? 'not-show' : 'flex'}`} id="users-actions">
                        <button className="btn btn-danger">
                            Delete &nbsp; &nbsp; <img src="./assets/images/delete-icon.svg" alt="delete"/>
                        </button>&nbsp;&nbsp;&nbsp;
                        <button className="btn btn-suspend">
                            Suspend &nbsp; &nbsp; <img src="./assets/images/suspend-icon.svg" alt="delete"/>
                        </button>
                    </div>
                </div>
            </div>
