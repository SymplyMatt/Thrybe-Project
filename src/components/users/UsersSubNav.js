...
const UsersSubNav = ({ showBtn, setShowBtn }) => {
  ...
  return (
        <div className="row justify-content-between align-items-center">
            ...
            <div className="col-lg-5 mt-3">
                <div className={`align-items-center justify-content-end ${!showBtn ? 'not-show' : ''}`} id="users-filter">
                    ...
                    <div className="position-relative">
                        <select className="filter-field2 font-sm" style={{ width: 'auto'}}>
                            ...
                            <option value="">Gold Users</option>
                            <option value="">Diamond Users</option>
                            <option value="">Boosted Accounts</option>
                            <option value="">Verified Users</option>
                        </select>

                            <i className="position-absolute fa fa-angle-down" style={{top:'10px', right:'10px'}}></i>
                    </div>
                    &nbsp;&nbsp;&nbsp;
                    <div className="position-relative">
                        <select className="filter-field2 font-sm px-4" style={{width: 'auto'}} defaultValue='Custom Date'>
                            ...
                            <i className="position-absolute fa fa-angle-down" style={{ top: '10px', right: '5px' }}></i>
                    </div>
                    <div className="dropdown messages-dropdown ml-4">
                        ...
                        >
                            <div className="position-relative drop-down-menu-inner">
                                <a className="dropdown-item" href="#">Alphabetical Order</a>
                                <a className="dropdown-item" href="#">Date Registered</a>
                                <a className="dropdown-item" href="#">Active Users</a>
                                <a className="dropdown-item" href="#">Suspended Users</a>
                                <a className="dropdown-item" href="#">Pending Review</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className={`align-items-center ${showBtn ? 'not-show' : 'flex'}`} id="users-actions">
