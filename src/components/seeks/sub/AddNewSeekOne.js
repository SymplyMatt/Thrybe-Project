...
const AddNewSeekOne = ({ page, setPage, seeksPage, setSeeksPage }) => {
      ...
      <div className="main-content">
				<div className="container-fluid">
					...
					<div className="row mb-5">
						...
						>
							<div className="d-flex align-item-center ml-2 basic-info-inner" onClick={()=>setSeeksPage('addnew-1')}>
								<div
							...
							<div className="d-flex mr-2">
								<div
									className="circle white d-flex justify-content-center align-item-center m-2" onClick={()=>setSeeksPage('addnew-2')}
								>
									<span>2</span>
								</div>
								<div
						...
						<div className="col-xl-5 col-md-8">
							<div className="custom-card mb-3">
								<form className="add-user-form">
									...
									<div
										className="mt-4 poster-div d-flex align-items-center position-relative mb-4"
									>
										<h6 className="mb-0">Post as</h6>
                  <div className="position-absolute" style={{ right: '-18px', top: '0' }}>
											<div
