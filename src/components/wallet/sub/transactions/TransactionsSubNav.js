        ...
        >
          ...
          <div className='position-relative'>
            <select className='filter-field2 font-sm' style={{ width: "auto" }}>
              ...
              <option value=''>Gold Transactions</option>
              <option value=''>Diamond Transactions</option>
              <option value=''>Boosted Accounts</option>
              <option value=''>Verified Transactions</option>
            </select>
...
export default TransactionsSubNav;
